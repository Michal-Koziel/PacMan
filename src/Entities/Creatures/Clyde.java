...
public class Clyde extends Creature{
	...
	public Clyde(Handler handler, float x, float y) {
		...
		//Animation
		AnimDown = new Animation(250,Assets.ClydeDown);
		AnimUp = new Animation(250,Assets.ClydeUp);
		AnimLeft = new Animation(250,Assets.ClydeLeft);
		AnimRight = new Animation(250,Assets.ClydeRight);
		LastAnim = new Animation(250,Assets.ClydeRight);
	}
