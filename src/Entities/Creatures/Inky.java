...
//Duch Inky z okreœlonym prostok¹tem kolizji oraz przypisan¹ animacj¹
public class Inky extends Creature{
	...
	public Inky(Handler handler, float x, float y,Entity Blinky) {
		...
		state = "Chase";
		//Animation
		ChaseDown = new Animation(250,Assets.InkyDown);
		ChaseUp = new Animation(250,Assets.InkyUp);
		ChaseLeft = new Animation(250,Assets.InkyLeft);
		ChaseRight = new Animation(250,Assets.InkyRight);
