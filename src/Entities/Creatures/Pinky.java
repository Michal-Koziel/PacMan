...
public class Pinky extends Creature{
	...
	public Pinky(Handler handler, float x, float y) {
		...
		//Animation
		AnimDown = new Animation(250,Assets.PinkyDown);
		AnimUp = new Animation(250,Assets.PinkyUp);
		AnimLeft = new Animation(250,Assets.PinkyLeft);
		AnimRight = new Animation(250,Assets.PinkyRight);
		LastAnim = new Animation(250,Assets.PinkyRight);
	}
